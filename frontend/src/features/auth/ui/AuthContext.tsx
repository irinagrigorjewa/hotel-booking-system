...
import { getMe as getCurrentUser } from '@entities/user/api/requests/getMe'
import { login as loginRequest } from '@entities/user/api/requests/login'
import { logout as logoutRequest } from '@entities/user/api/requests/logout'
import { register as registerRequest } from '@entities/user/api/requests/register'
import type { LoginRequest, RegisterRequest, TokenPair } from '@entities/user/model/auth-types'
